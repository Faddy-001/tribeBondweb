...
@Component({
  selector: 'app-detail-automobile',

  templateUrl: './detail-automobile.component.html',
  styleUrl: './detail-automobile.component.scss'
})
export class DetailAutomobileComponent {
  images!: any[];
...
navigateEdit(id:number): void {
    this.router.navigateByUrl(`/tribe/automobileList/edit-auto/${this.idParam}`);
  }
