...
@Component({
  selector: 'app-detail-halal-meat',

  templateUrl: './detail-halal-meat.component.html',
  styleUrl: './detail-halal-meat.component.scss'
})
export class DetailHalalMeatComponent {
  images!: any[];
  allData: any
  reviewRespShow: any = [];
  entities: any
