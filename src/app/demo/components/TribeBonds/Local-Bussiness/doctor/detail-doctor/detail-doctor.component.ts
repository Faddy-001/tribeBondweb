...
@Component({
  ...
  styleUrl: './detail-doctor.component.scss'
})
...
navigateEdit(id:number): void {
    this.router.navigateByUrl(`/tribe/doctorList/edit-doc/${this.idParam}`);
  }
