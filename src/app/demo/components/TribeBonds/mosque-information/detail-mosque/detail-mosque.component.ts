...
@Component({
  ...
  templateUrl: './detail-mosque.component.html',
  styleUrl: './detail-mosque.component.scss'
})
export class DetailMosqueComponent {
  images!: any[];
  rowCount = 3;
  ...
  ngOnInit() {
    ...
    this.getbyIDMosqueDisplay();
  }

  getbyIDMosqueDisplay() {
  ...
  navigateEdit(id: number): void {
    this.router.navigateByUrl(`/tribe/mosqueList/edit-mos/${this.idParam}`);
  }
